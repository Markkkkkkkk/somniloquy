...
![](https://image.hyly.net/i/2025/09/26/2b99c07d6903eecc9dbf682571d03903-0.webp)
...
![](C:\Users\Ning\Desktop\文档\img\解耦1.png)

使用消息队列解耦合，系统的耦合性就会提高了。比如物流系统发生故障，需要几分钟才能来修复，在这段时间内，物流系统要处理的数据被缓存到消息队列中，用户的下单操作正常完成。当物流系统回复后，补充处理存在消息队列中的订单消息即可，终端系统感知不到物流系统发生过几分钟故障。

![](C:\Users\Ning\Desktop\文档\img\解耦2.png)

* 流量削峰

![](https://image.hyly.net/i/2025/09/26/d199bb4391fc3db17511be0a17dea49b-0.webp)

应用系统如果遇到系统请求流量的瞬间猛增，有可能会将系统压垮。有了消息队列可以将大量请求缓存起来，分散到很长一段时间处理，这样可以大大提到系统的稳定性和用户体验。

![](https://image.hyly.net/i/2025/09/26/d5f4d1f829b6f5d2a0beff9f5e40e4c3-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/76e6b583d27ca179c3cbeb6ac68893ca-0.webp)

通过消息队列可以让数据在多个系统更加之间进行流通。数据的产生方不需要关心谁来使用数据，只需要将数据发送到消息队列，数据使用方直接在消息队列中直接获取数据即可

![](https://image.hyly.net/i/2025/09/26/d18892b7166348b3e94328540e4bef1b-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/7fe5d75ed3023f144e464514e8ae799d-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/e368a49828df79c5c803ee1ac02f7129-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/f7abe1fb3583872f7c55afc96521765a-0.webp)
...
<thead>
<tr><th><strong>序号</strong></th><th><strong>IP</strong></th><th><strong>角色</strong></th><th><strong>架构模式</strong></th></tr></thead>
<tbody><tr><td>1</td><td>192.168.25.135</td><td>nameserver、brokerserver</td><td>Master1、Slave2</td></tr><tr><td>2</td><td>192.168.25.138</td><td>nameserver、brokerserver</td><td>Master2、Slave1</td></tr></tbody>
</table></figure>
...
![](https://image.hyly.net/i/2025/09/26/a6632e20ea319b5567b1d3dd4bc57cea-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/590de63f67c99c927207a5a1459a5bc8-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/48dea7a4206552314d32e98b9ccb92de-0.webp)

集群状态：

![](https://image.hyly.net/i/2025/09/26/d4832820d54ac1e7ba955e82aa6422e5-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/aeb4c0bcdcc03afceb5f56b6ec45fc30-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/b31290fd1fec69dedbd677cf28f79d77-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/84cd984c29582bbb66acfb660bc4a611-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/056464a80d3307dd80e9dc150dcccdb5-0.webp)

<u>使用MQ保证在下单失败后系统数据的完整性</u>

![](https://image.hyly.net/i/2025/09/26/c4033c17aa9c53d050722292e72d26ee-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/f6da842151a87109b2ac8c6d87f65e55-0.webp)

<u>通过MQ进行数据分发，提高系统处理性能</u>

![](https://image.hyly.net/i/2025/09/26/2927d3c09f4ebf822bc02c20e90935d8-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/84323a6146eafcad168aa5d004308299-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/03eebd7e5f2708dab1ab1156bd3c77aa-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/3edea3212fdacd34446a9b8a1b8dd18d-0.webp)
...
<figure class='table-figure'><table>
<thead>
<tr><th>Field</th><th>Type</th><th>Comment</th></tr></thead>
<tbody><tr><td>coupon_id</td><td>bigint(50) NOT NULL</td><td>优惠券ID</td></tr><tr><td>coupon_price</td><td>decimal(10,2) NULL</td><td>优惠券金额</td></tr><tr><td>user_id</td><td>bigint(50) NULL</td><td>用户ID</td></tr><tr><td>order_id</td><td>bigint(32) NULL</td><td>订单ID</td></tr><tr><td>is_used</td><td>int(1) NULL</td><td>是否使用 0未使用 1已使用</td></tr><tr><td>used_time</td><td>timestamp NULL</td><td>使用时间</td></tr></tbody>
</table></figure>
...
<thead>
<tr><th>Field</th><th>Type</th><th>Comment</th></tr></thead>
<tbody><tr><td>goods_id</td><td>bigint(50) NOT NULL</td><td>主键</td></tr><tr><td>goods_name</td><td>varchar(255) NULL</td><td>商品名称</td></tr><tr><td>goods_number</td><td>int(11) NULL</td><td>商品库存</td></tr><tr><td>goods_price</td><td>decimal(10,2) NULL</td><td>商品价格</td></tr><tr><td>goods_desc</td><td>varchar(255) NULL</td><td>商品描述</td></tr><tr><td>add_time</td><td>timestamp NULL</td><td>添加时间</td></tr></tbody>
</table></figure>
...
<thead>
<tr><th>Field</th><th>Type</th><th>Comment</th></tr></thead>
<tbody><tr><td>goods_id</td><td>int(11) NOT NULL</td><td>商品ID</td></tr><tr><td>order_id</td><td>varchar(32) NOT NULL</td><td>订单ID</td></tr><tr><td>goods_number</td><td>int(11) NULL</td><td>库存数量</td></tr><tr><td>log_time</td><td>datetime NULL</td><td>记录时间</td></tr></tbody>
</table></figure>
...
<thead>
<tr><th>Field</th><th>Type</th><th>Comment</th></tr></thead>
<tbody><tr><td>user_id</td><td>bigint(50) NOT NULL</td><td>用户ID</td></tr><tr><td>user_name</td><td>varchar(255) NULL</td><td>用户姓名</td></tr><tr><td>user_password</td><td>varchar(255) NULL</td><td>用户密码</td></tr><tr><td>user_mobile</td><td>varchar(255) NULL</td><td>手机号</td></tr><tr><td>user_score</td><td>int(11) NULL</td><td>积分</td></tr><tr><td>user_reg_time</td><td>timestamp NULL</td><td>注册时间</td></tr><tr><td>user_money</td><td>decimal(10,0) NULL</td><td>用户余额</td></tr></tbody>
</table></figure>
...
<thead>
<tr><th>Field</th><th>Type</th><th>Comment</th></tr></thead>
<tbody><tr><td>user_id</td><td>bigint(50) NOT NULL</td><td>用户ID</td></tr><tr><td>order_id</td><td>bigint(50) NOT NULL</td><td>订单ID</td></tr><tr><td>money_log_type</td><td>int(1) NOT NULL</td><td>日志类型 1订单付款 2 订单退款</td></tr><tr><td>use_money</td><td>decimal(10,2) NULL</td><td>操作金额</td></tr><tr><td>create_time</td><td>timestamp NULL</td><td>日志时间</td></tr></tbody>
</table></figure>
...
<thead>
<tr><th>Field</th><th>Type</th><th>Comment</th></tr></thead>
<tbody><tr><td>pay_id</td><td>bigint(50) NOT NULL</td><td>支付编号</td></tr><tr><td>order_id</td><td>bigint(50) NULL</td><td>订单编号</td></tr><tr><td>pay_amount</td><td>decimal(10,2) NULL</td><td>支付金额</td></tr><tr><td>is_paid</td><td>int(1) NULL</td><td>是否已支付 1否 2是</td></tr></tbody>
</table></figure>
...
<thead>
<tr><th>Field</th><th>Type</th><th>Comment</th></tr></thead>
<tbody><tr><td>id</td><td>varchar(100) NOT NULL</td><td>主键</td></tr><tr><td>group_name</td><td>varchar(100) NULL</td><td>生产者组名</td></tr><tr><td>msg_topic</td><td>varchar(100) NULL</td><td>消息主题</td></tr><tr><td>msg_tag</td><td>varchar(100) NULL</td><td>Tag</td></tr><tr><td>msg_key</td><td>varchar(100) NULL</td><td>Key</td></tr><tr><td>msg_body</td><td>varchar(500) NULL</td><td>消息内容</td></tr><tr><td>msg_status</td><td>int(1) NULL</td><td>0:未处理;1:已经处理</td></tr><tr><td>create_time</td><td>timestamp NOT NULL</td><td>记录时间</td></tr></tbody>
</table></figure>
...
<thead>
<tr><th>Field</th><th>Type</th><th>Comment</th></tr></thead>
<tbody><tr><td>msg_id</td><td>varchar(50) NULL</td><td>消息ID</td></tr><tr><td>group_name</td><td>varchar(100) NOT NULL</td><td>消费者组名</td></tr><tr><td>msg_tag</td><td>varchar(100) NOT NULL</td><td>Tag</td></tr><tr><td>msg_key</td><td>varchar(100) NOT NULL</td><td>Key</td></tr><tr><td>msg_body</td><td>varchar(500) NULL</td><td>消息体</td></tr><tr><td>consumer_status</td><td>int(1) NULL</td><td>0:正在处理;1:处理成功;2:处理失败</td></tr><tr><td>consumer_times</td><td>int(1) NULL</td><td>消费次数</td></tr><tr><td>consumer_timestamp</td><td>timestamp NULL</td><td>消费时间</td></tr><tr><td>remark</td><td>varchar(500) NULL</td><td>备注</td></tr></tbody>
</table></figure>
...
![](https://image.hyly.net/i/2025/09/26/774d03be4631655270289677a4e9ed16-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/5ddadfb1737f010ac3e2353ca795f169-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/8d603a18a7eaf31b3b4b166cf43ddb9a-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/316a012b6080078bed70a1dc5734df06-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/49abbe529049638cf568636c819721ed-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/dfa36193a0b55adc75e2c0807f1051f0-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/86ac54063ba300cc5eebe2eb08959499-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/7fff133f7d9dc9baec13dbf7411ba2d3-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/462366f30fec339b094720be0b8c8061-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/d5193f3b49d29ffe348e3f8050f6c337-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/8e5ace1c80f00e7f9c3599fee02dd023-0.webp)
...
- 文件系统
	...
	![](https://image.hyly.net/i/2025/09/26/1db3ea23d1fc020ce5e82a9fe09a4603-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/f95d668d7f633f5484b7af4aaec84604-0.webp)通过使用mmap的方式，可以省去向用户态的内存复制，提高速度。这种机制在Java中是通过MappedByteBuffer实现的
...
![](https://image.hyly.net/i/2025/09/26/a0215e19e8a8507df6368ea00e2019d0-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/b961c58cbfe6c60cdf9d935814c54501-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/56827d766a7eb1c199e2df49350ccf79-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/3af1e9d36ae553dc62a51beddb45676e-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/8f183a7b42aeffebe0df65bdd3b6a520-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/40fb916ac6dbc6646e2c8c67b53f0135-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/c88a63523c0533d46b5930c2dbc09223-0.webp)

还有另外一种平均的算法是AllocateMessageQueueAveragelyByCircle，也是平均分摊每一条queue，只是以环状轮流分queue的形式，如下图：

![](https://image.hyly.net/i/2025/09/26/33bf786ac07511eaa83e143f721cbb3b-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/db8f19e18d8446e133bb092b872dbfe1-0.webp)
...
<figure class='table-figure'><table>
<thead>
<tr><th style='text-align:center;' >第几次重试</th><th style='text-align:center;' >与上次重试的间隔时间</th><th style='text-align:center;' >第几次重试</th><th style='text-align:center;' >与上次重试的间隔时间</th></tr></thead>
<tbody><tr><td style='text-align:center;' >1</td><td style='text-align:center;' >10 秒</td><td style='text-align:center;' >9</td><td style='text-align:center;' >7 分钟</td></tr><tr><td style='text-align:center;' >2</td><td style='text-align:center;' >30 秒</td><td style='text-align:center;' >10</td><td style='text-align:center;' >8 分钟</td></tr><tr><td style='text-align:center;' >3</td><td style='text-align:center;' >1 分钟</td><td style='text-align:center;' >11</td><td style='text-align:center;' >9 分钟</td></tr><tr><td style='text-align:center;' >4</td><td style='text-align:center;' >2 分钟</td><td style='text-align:center;' >12</td><td style='text-align:center;' >10 分钟</td></tr><tr><td style='text-align:center;' >5</td><td style='text-align:center;' >3 分钟</td><td style='text-align:center;' >13</td><td style='text-align:center;' >20 分钟</td></tr><tr><td style='text-align:center;' >6</td><td style='text-align:center;' >4 分钟</td><td style='text-align:center;' >14</td><td style='text-align:center;' >30 分钟</td></tr><tr><td style='text-align:center;' >7</td><td style='text-align:center;' >5 分钟</td><td style='text-align:center;' >15</td><td style='text-align:center;' >1 小时</td></tr><tr><td style='text-align:center;' >8</td><td style='text-align:center;' >6 分钟</td><td style='text-align:center;' >16</td><td style='text-align:center;' >2 小时</td></tr></tbody>
</table></figure>
...
![](https://image.hyly.net/i/2025/09/26/89b002a39c6e5d0969e168171b57523b-0.webp)

2. 在消息界面根据主题查询死信消息

![](https://image.hyly.net/i/2025/09/26/4a5ec9639cc2912552fbeb7252ecbd64-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/7fd03debd47b77358bf26b6d7b1b4ac8-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/e27d20e309eeb7d977454d4e07f07f4c-0.webp)
...
![](https://image.hyly.net/i/2025/09/26/50e7a974f34d03b1395aa3554c38bf5c-0.webp)

##### 1）启动NameServer

* 展开namesrv模块，右键NamesrvStartup.java

![](https://image.hyly.net/i/2025/09/26/274c4c98a4bfcf95fd7cca4e79893376-0.webp)

* 配置**ROCKETMQ_HOME**

![](https://image.hyly.net/i/2025/09/26/f03e2eebb8801c78773aab954ba875d6-0.webp)

![](https://image.hyly.net/i/2025/09/26/2a5c454dbc037216f72acaeed9e00f84-0.webp)
...
![](https://image.hyly.net/i/2025/09/26
...
![img](https://image.hyly.net/i/2025/09/24/d1ddff43e070d1c1a83398ab0313f05e-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/4951d1667226d2fcd3eaab9276f28647-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/efe8531a15483250ad3c3eca453ca3f0-0.webp)

C和C++语言在执行过程中，只需要将源代码编译成可执行文件，就包含了计算机能识别的机器码，无需在运行过程中再实时地解释，所以性能较高。

![img](https://image.hyly.net/i/2025/09/24/678ab00ad4953c0f2ac5b1488585d2d1-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/a34dd3d2440c623a0db3b6314a3e3a8f-0.webp)

但是C/C++语言，如果要让程序在不同平台上运行，就需要将一份源代码在不同平台上分别进行编译，相对来说比较麻烦。

再回到即时编译，在JDK1.1的版本中就推出了即时编译去优化对应的性能。

![img](https://image.hyly.net/i/2025/09/24/bdb4649cf7867f71c29f0b0f24ffebdf-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/26b5fea63ec5f5ba4e1a4387345c6418-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/4eda5b337bd3ee35fe3fecd732bc9b12-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/56857f87eab3d7047e780c827b6e0f35-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/4ac85aecd71c3d50264d96e2b105e9c2-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/fdf2cd77002e63cec2e68ba6cde4c4e5-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/dd164eaa44833a111c4b9d759cca8850-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/486753813f37cd8a1f14c4dfead3bd27-0.webp)

版本号的作用主要是判断当前字节码的版本和运行时的JDK是否兼容。如果使用较低版本的JDK去运行较高版本JDK的字节码文件，无法使用会显示如下错误：

![img](https://image.hyly.net/i/2025/09/24/d79aca89cbc5aeab4b9a616d6eec52c9-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/7ec4305dc181af3b00197311d16bac35-0.webp)

#####  常量池

字节码文件中常量池的作用：避免相同的内容重复定义，节省空间。如下图，常量池中定义了一个字符串，字符串的字面量值为123。

![img](https://image.hyly.net/i/2025/09/24/78d9c9f1bff296f7ac9e40315a54a977-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/f2d734de06bf0f82a235fa4f1cd0fda2-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/a8dcb08b4c4cffbcbcabf974fa8ac0b4-0.webp)

#####  方法

字节码中的方法区域是存放**字节码****指令**的核心位置，字节码指令的内容存放在方法的Code属性中。

![img](https://image.hyly.net/i/2025/09/24/aefc8c24e25fc435881af6a63a96506a-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/8e2a4fc885ed962c1dabb014c2ed24ae-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/6900a28adca2c03fa5926e5d61d29b61-0.webp)

2、istore_1会从操作数栈中，将栈顶的元素弹出来，此时0会被弹出，放入局部变量表的1号位置。局部变量表中的1号位置，在编译时就已经确定是局部变量i使用的位置。完成了对局部变量i的赋值操作。

![img](https://image.hyly.net/i/2025/09/24/cd00ac4f809e328c4ffab129411083ea-0.webp)

3、iload_1将局部变量表1号位置的数据放入操作数栈中，此时栈中会放入0。

![img](https://image.hyly.net/i/2025/09/24/471aa908c39a993a5a2ee6f39d5ea3cd-0.webp)

4、iconst_1会将常量1放入操作数栈中。

![img](https://image.hyly.net/i/2025/09/24/e60a44d881a54ff22808b96519107616-0.webp)

5、iadd会将操作数栈顶部的两个数据相加，现在操作数栈上有两个数0和1，相加之后结果为1放入操作数栈中，此时栈上只有一个数也就是相加的结果1。

![img](https://image.hyly.net/i/2025/09/24/249c2dd0e167ac440241184d3be5198b-0.webp)

6、istore_2从操作数栈中将1弹出，并放入局部变量表的2号位置，2号位置是j在使用。完成了对局部变量j的赋值操作。

![img](https://image.hyly.net/i/2025/09/24/25ebc415fa44dd6d8de972ce857700b8-0.webp)

7、return语句执行，方法结束并返回。

![img](https://image.hyly.net/i/2025/09/24/15e3f9e5c793258eabfae70d9cc87a1b-0.webp)

同理，同学们可以自行分析下i++和++i的字节码指令执行的步骤。

i++的字节码指令如下，其中iinc 1 by 1指令指的是将局部变量表1号位置增加1，其实就实现了i++的操作。

![img](https://image.hyly.net/i/2025/09/24/0a73727bdbcf05b9dfa5c2c7be30fd18-0.webp)

而++i只是对两个字节码指令的顺序进行了更改：

![img](https://image.hyly.net/i/2025/09/24/f07f9fe8bff497a2cb11b7829c860bba-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/6794bd3edccc88313cd0d99062d275e8-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/fd672db762f69a4b1e093d7135062ecc-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/78c7074076cb2a7dcc4126bbc7a306b9-0.webp)

2、选中要查看的源代码文件，选择 视图(View) - Show Bytecode With Jclasslib

![img](https://image.hyly.net/i/2025/09/24/75472a8f6206aeb8a9244352f77bed1c-0.webp)

右侧会展示对应源代码编译后的字节码文件内容：

![img](https://image.hyly.net/i/2025/09/24/fcc306c5769fe68c068b7d063292d235-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/2debfdd43e7cf4c3ad6a95da34ec9337-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/28c97712d7379cda15601deb2750a425-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/3c0c1f84e1d37d85ebb5102a666ef23f-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/a910db7357f936a02e5ccfe5f2c1339a-0.webp)

4、Java虚拟机同时会在堆上生成与方法区中数据类似的java.lang.Class对象，作用是在Java代码中去获取类的信息以及存储静态字段的数据（JDK8及之后）。

![img](https://image.hyly.net/i/2025/09/24/991dc8a3b97c473c1ea892189865e2ac-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/ac734d5e413a6ced875b5a13724746b8-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/7505254b7ac0f48ad059e86e7afefe2b-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/88bf7eec2dd9cfd0ea61029b0def71b1-0.webp)
...
<figure class='table-figure'><table>
<thead>
<tr><th><strong>数据类型</strong></th><th><strong>初始值</strong></th></tr></thead>
<tbody><tr><td><strong>int</strong></td><td><strong>0</strong></td></tr><tr><td><strong>long</strong></td><td><strong>0L</strong></td></tr><tr><td><strong>short</strong></td><td><strong>0</strong></td></tr><tr><td><strong>char</strong></td><td><strong>‘\u0000’</strong></td></tr><tr><td><strong>byte</strong></td><td><strong>0</strong></td></tr><tr><td><strong>boolean</strong></td><td><strong>false</strong></td></tr><tr><td><strong>double</strong></td><td><strong>0.0</strong></td></tr><tr><td><strong>引用*</strong>*数据类型**</td><td><strong>null</strong></td></tr></tbody>
</table></figure>
...
![img](https://image.hyly.net/i/2025/09/24/7ab270973c1660edb5a144a10bdcb741-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/57a0468f1f16e389e6875ae3fd4c54fa-0.webp)

##### 解析

解析阶段主要是将常量池中的符号引用替换为直接引用，符号引用就是在字节码文件中使用编号来访问常量池中的内容。

![img](https://image.hyly.net/i/2025/09/24/445dd85f4edc70ef4114381223251b44-0.webp)

直接引用不在使用编号，而是使用内存中地址进行访问具体的数据。

![img](https://image.hyly.net/i/2025/09/24/e7f5348c99df5381cea17f04064d3ef8-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/a86f02ee2444d1741f11784798ac2a50-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/ea0e9b30c3926dc1c31af9581ad498ef-0.webp)

2、putstatic指令会将操作数栈上的数弹出来，并放入堆中静态变量的位置，字节码指令中#2指向了常量池中的静态变量value，在解析阶段会被替换成变量的地址。

![img](https://image.hyly.net/i/2025/09/24/d375c33d6bc3d1752e591d5b1253db09-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/0ddc408ecc88069e26b4810ac782d9c5-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/bb14ee70068acd5b4814ba6ba1755148-0.webp)

指令会输出D

2、执行main方法的字节码指令。

![img](https://image.hyly.net/i/2025/09/24/7da82a8f39bfb1a80f365f11362e84e6-0.webp)

指令会输出A

3、创建两个对象，会执行两次对象初始化的指令。

![img](https://image.hyly.net/i/2025/09/24/cbc223e92b6beb6b2d48afa265d765ad-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/b09974be79838d51789f176beb39e32b-0.webp)

3.静态变量的定义使用final关键字，这类变量会在准备阶段直接进行初始化。

![img](https://image.hyly.net/i/2025/09/24/cb86946224d4009eff920a616918c446-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/24d03b05107367121837f3349deaa066-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/d3394a8dbf7b1f8d7e599b5193d1fa22-0.webp)

类加载器的详细信息可以通过Arthas的classloader命令查看：

> `classloader` - 查看 classloader 的继承树，urls，类加载信息，使用 classloader 去 getResource

![img](https://image.hyly.net/i/2025/09/24/6d1662987291b0d7116c70fb31cfbb97-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/0116392e0bd82a22c231b7b0349d8ff3-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/7b2c11561e2e89aa4d6ee5defb04cdb9-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/2005ae541d973c0b0b5e462c626ae775-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/1507d2aba01fdfc3fdfc69991b32084f-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/9662cc6b48da9bb44405b55a98769b66-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/30e211642c273c53380ba22be1553c94-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/846976916f39f507eb3c111481ed6d51-0.webp)

这两个类均由应用程序类加载器加载。

类加载器的加载路径可以通过classloader –c hash值 查看：

![img](https://image.hyly.net/i/2025/09/24/501b56c7ee6828c98b80534e659b326e-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/fb347c76652260e486d92c9fb549f395-0.webp)

详细流程：

每个类加载器都有一个父类加载器。父类加载器的关系如下，启动类加载器没有父类加载器：

![img](https://image.hyly.net/i/2025/09/24/5aef54221fc39009f95c5cc8ba8cab8d-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/1c868a333f11508a60d5b9470ff1309b-0.webp)

2、扩展类加载器也没加载过，交给他的父类加载器 - 启动类加载器。

![img](https://image.hyly.net/i/2025/09/24/8756a772fcd69358500ccd7b340e9248-0.webp)

3、启动类加载器发现已经加载过，直接返回。

![img](https://image.hyly.net/i/2025/09/24/b3ae49d013f4f2716fc0a8d451f95736-0.webp)

#### 案例2：

B类在扩展类加载器加载路径中，同样应用程序类加载器接到了加载任务，按照案例1中的方式一层一层向上查找，发现都没有加载过。那么启动类加载器会首先尝试加载。它发现这类不在它的加载目录中，向下传递给扩展类加载器。

![img](https://image.hyly.net/i/2025/09/24/0b08c7a29cbe3dc3a509bed91ab44182-0.webp)

扩展类加载器发现这个类在它加载路径中，加载成功并返回。

![img](https://image.hyly.net/i/2025/09/24/4c396c544f826c734397623417ceeef2-0.webp)

如果第二次再接收到加载任务，同样地向上查找。扩展类加载器发现已经加载过，就可以返回了。

![img](https://image.hyly.net/i/2025/09/24/1556d72ca84d929f686e0295b9e682cb-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/e889286bf1a4b2c01ef96479b15296d0-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/9a1aea17492e7fe9910a39b4800441df-0.webp)

Tomcat使用了自定义类加载器来实现应用之间类的隔离。 每一个应用会有一个独立的类加载器加载对应的类。

![img](https://image.hyly.net/i/2025/09/24/ebb4f483aaee480a8ba13663272c1003-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/5c19538941b33d025f7b154114044687-0.webp)

2、再进入看下：

![img](https://image.hyly.net/i/2025/09/24/8430877fddf8d39174311fc37b67b7de-0.webp)

如果查找都失败，进入加载阶段，首先会由启动类加载器加载，这段代码在`findBootstrapClassOrNull`中。如果失败会抛出异常，接下来执行下面这段代码：

![img](https://image.hyly.net/i/2025/09/24/4ada688ed41bd804253607aad44daeb7-0.webp)

父类加载器加载失败就会抛出异常，回到子类加载器的这段代码，这样就实现了加载并向下传递。

3、最后根据传入的参数判断是否进入连接阶段：

![img](https://image.hyly.net/i/2025/09/24/c73e47e8080842d67690c335be1cfab3-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/442e42a80a9de3d98ce0dc07ab061a6c-0.webp)

以Jdk8为例，ClassLoader类中提供了构造方法设置parent的内容：

![img](https://image.hyly.net/i/2025/09/24/936512e0a79481e72e39c7968cc15c33-0.webp)

这个构造方法由另外一个构造方法调用，其中父类加载器由getSystemClassLoader方法设置，该方法返回的是AppClassLoader。

![img](https://image.hyly.net/i/2025/09/24/1508c50be91731f4cf55ed40058ab27b-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/f5f8cac93940c772ff0b97b7b42729b8-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/db2eee1d841e49614bb4a7f2d90bbcb6-0.webp)

3、依赖中的mysql驱动对应的类，由应用程序类加载器来加载。

![img](https://image.hyly.net/i/2025/09/24/bec20731b33e99e6aaf81da88dae06d8-0.webp)

在类中有初始化代码：

![img](https://image.hyly.net/i/2025/09/24/9b1e1855fa098bf0072b87eeef27359a-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/1bc31bbc52dcbd35ef815830e4ad774b-0.webp)

2、这里使用了SPI机制，去加载所有jar包中实现了Driver接口的实现类。

![img](https://image.hyly.net/i/2025/09/24/eb4018dcc507b03514ee49c871b61631-0.webp)

3、SPI机制就是在这个位置下存放了一个文件，文件名是接口名，文件里包含了实现类的类名。这样SPI机制就可以找到实现类了。

![img](https://image.hyly.net/i/2025/09/24/4cf2c82d199738c4dce2f9b2c458bf89-0.webp)

![img](https://image.hyly.net/i/2025/09/24/1c9bdb3e3758298ab75458f23163d1c3-0.webp)

4、SPI中利用了线程上下文类加载器（应用程序类加载器）去加载类并创建对象。

![img](https://image.hyly.net/i/2025/09/24/e9081da55da5a78f44b88371c2833ead-0.webp)

总结：

![img](https://image.hyly.net/i/2025/09/24/1ad52071d1f13a2459888c497331e65a-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/76cb2767ce16fd33ff47146c6bcbf201-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/0776892d4b358e408e05f1f400b70fbf-0.webp)

2、枚举中是这样定义的，1001是普通用户，1002是VIP用户：

![img](https://image.hyly.net/i/2025/09/24/8b01ab0dc9a21988f1c186cbff767d6b-0.webp)

3、由于代码有误，导致传递1001参数时，返回的是收费用户的内容。

![img](https://image.hyly.net/i/2025/09/24/605220a49961f5b91e3156655a330748-0.webp)

4、`jad --source-only 类全限定名 > 目录/文件名.java` 使用 jad 命令反编译，然后可以用其它编译器，比如 vim 来修改源码

![img](https://image.hyly.net/i/2025/09/24/6e4fc56cd0f74daa8c6d9c1c1fd648f9-0.webp)

这里直接双击文件使用finalShell编辑：

![img](https://image.hyly.net/i/2025/09/24/045c82b62ea579eddf774933e66a6d96-0.webp)

5、`mc –c 类加载器的hashcode 目录/文件名.java -d 输出目录` 使用mc 命令用来编译修改过的代码

![img](https://image.hyly.net/i/2025/09/24/f18a9ae8b560f702d842fe3fb5c8e752-0.webp)

6、`retransform class文件所在目录/xxx.class` 用 retransform 命令加载新的字节码

![img](https://image.hyly.net/i/2025/09/24/b22b4941a594eef5d0b9218083341350-0.webp)

7、测试：

![img](https://image.hyly.net/i/2025/09/24/b076ad3b94bec1db9cc84268599b919a-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/72d71e58cb3e7e43a318d7b33b4f8939-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/37adfe8934d92f99a58e47ca1c1ecbf3-0.webp)

###  程序计数器

程序计数器（Program Counter Register）也叫PC寄存器，每个线程会通过程序计数器记录当前要执行的的字节码指令的地址。

![img](https://image.hyly.net/i/2025/09/24/c4c5e8a91db2e8a90a66ef9864cee8fc-0.webp)

一个程序计数器的具体案例：

在加载阶段，虚拟机将字节码文件中的指令读取到内存之后，会将原文件中的偏移量转换成内存地址。每一条字节码指令都会拥有一个内存地址。

![img](https://image.hyly.net/i/2025/09/24/8418a26a89290a2ff2da27b6004b6668-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/d025a48271b1a7443648bf7438a0d518-0.webp)

一路向下执行

![img](https://image.hyly.net/i/2025/09/24/9da2201c539dd1d21116da995509121f-0.webp)

一直执行到方法的最后一行指令，此时方法执行return语句，当前方法执行结束，程序计数器中会放入方法出口的地址（栈中讲解，简单来说就是这个B方法结束了，A调用了B，那么要回到A方法）

![img](https://image.hyly.net/i/2025/09/24/7973a02f867b106d9987fa359251f773-0.webp)

所以，程序计数器可以控制程序指令的进行，实现分支、跳转、异常等逻辑。不管是分支、跳转、异常，只需要在程序计数器中放入下一行要执行的指令地址即可。

在多线程执行情况下，Java虚拟机需要通过程序计数器记录CPU切换前解释执行到那一句指令并继续解释运行。

![img](https://image.hyly.net/i/2025/09/24/c953a4b873b2357efeefca0fb9634f3a-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/5707840d68502e8e664f853d111b46d9-0.webp)

接下来执行study方法，会创建study方法的栈帧

![img](https://image.hyly.net/i/2025/09/24/41b810505ec378165b6cbbdedad717cc-0.webp)

进入eat方法，创建eat方法的栈帧

![img](https://image.hyly.net/i/2025/09/24/ea8204aee631b4f36f719b20e22f9487-0.webp)

eat方法执行完之后，会弹出它的栈帧：

![img](https://image.hyly.net/i/2025/09/24/f8547c095929c8d725933e59a026e253-0.webp)

然后调用sleep方法，创建sleep方法栈帧

![img](https://image.hyly.net/i/2025/09/24/08e016c1282c91b0b4fc2d766292ee38-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/2d6c737439a0988438b9640824b5c440-0.webp)

Java虚拟机栈随着线程的创建而创建，而回收则会在线程的销毁时进行。由于方法可能会在不同线程中执行，每个线程都会包含一个自己的虚拟机栈。如下就有两个线程的虚拟机栈，main线程和线程A。

![img](https://image.hyly.net/i/2025/09/24/a633645559c5ec451fdee624c587b5d2-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/5063abf7725ba45f45ff4335e1ca4e4e-0.webp)

局部变量表中保存了字节码指令生效的偏移量：

![img](https://image.hyly.net/i/2025/09/24/0307df1468c94beb78badd7716c5c2d1-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/9ba48c94871f48f6016fb2bc835e6204-0.webp)

`i`占用数组下标为0的位置，`j`占用数组下标1-2的位置。

刚才看到的是静态方法，实例方法中的序号为0的位置存放的是this，指的是当前调用方法的对象，运行时会在内存中存放实例对象的地址。

![img](https://image.hyly.net/i/2025/09/24/c404904106d22604ea1f0e05d4d57e10-0.webp)

方法参数也会保存在局部变量表中，其顺序与方法中参数定义的顺序一致。局部变量表保存的内容有：实例方法的this对象，方法的参数，方法体中声明的局部变量。

![img](https://image.hyly.net/i/2025/09/24/0ffad4d76cbc93eb504ef1a34540b25e-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/c6c2eb78433969fd9d2753105a2c7c15-0.webp)

2、将1的值放入局部变量表下标为3的位置上，相当于给a进行赋值。

![img](https://image.hyly.net/i/2025/09/24/f6ffd8b4a9f11db17f6f5b577c3468dc-0.webp)

3、将2放入局部变量表下标为4的位置，给b赋值为2。

![img](https://image.hyly.net/i/2025/09/24/8e9420ce18c93da71ea9be413312bcce-0.webp)

4、ab已经脱离了生效范围，所以下标为3和4的这两个位置可以复用。此时c的值1就可以放入下标为3的位置。

![img](https://image.hyly.net/i/2025/09/24/9478a3bdca4ee0b17752e34e2b59df17-0.webp)

4、脱离c的生效范围之后，给i赋值就可以复用c的位置。

![img](https://image.hyly.net/i/2025/09/24/acaffe6c0653585e1e2a9b10808415b5-0.webp)

5、最后放入j，j是一个long类型，占用两个槽。但是可以复用b所在的位置，所以占用4和5这两个位置

![img](https://image.hyly.net/i/2025/09/24/55a3fc12d1143bbf4cac4f42fb3e1c77-0.webp)

所以，局部变量表数值的长度为6。这一点在编译期间就可以确定了，运行过程中只需要在栈帧中创建长度为6的数组即可。

![img](https://image.hyly.net/i/2025/09/24/2a22a498c9fb8f7eae0d95c35c259b67-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/f24c1fdcd84ce3f8f099a1f7687a6b2c-0.webp)

比如之前的相加案例中，操作数栈最大的深入会出现在这个时刻：

![img](https://image.hyly.net/i/2025/09/24/6d7740fa6af701b516e39698c30bf3e8-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/f34d2a2b40c7b8a9086903264a7c2776-0.webp)

##### 方法出口

方法出口指的是方法在正确或者异常结束时，当前栈帧会被弹出，同时程序计数器应该指向上一个栈帧中的下一条指令的地址。所以在当前栈帧中，需要存储此方法出口的地址。

![img](https://image.hyly.net/i/2025/09/24/fb271ad03f158b1c1f35a3ed0d16949a-0.webp)

##### 异常表

异常表存放的是代码中异常的处理信息，包含了异常捕获的生效范围以及异常发生后跳转到的字节码指令位置。

![img](https://image.hyly.net/i/2025/09/24/22c314db9121a3c33fa763ea72a26423-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/3a926e27a4e68db1ae413c4c9104f1a5-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/1e2965a4c41c91eabce1186f7951e5cc-0.webp)

如果我们不指定栈的大小，JVM 将创建一个具有默认大小的栈。大小取决于操作系统和计算机的体系结构。

![img](https://image.hyly.net/i/2025/09/24/a5eeda1dc47d10f57615d4a296c7d29b-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/da91394b94315b38c0e7dcd2c46e9c61-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/6fe5271336bb5db7fef2b406d50ca5d2-0.webp)

调成512k之后，明显发现最大栈帧数量减少了：

![img](https://image.hyly.net/i/2025/09/24/4f6446273e126ccc36736e20ef76a152-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/6c4028a4c9db8a22651a58ee6b4e8f1b-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/60fcd930aadf696679485de0000bc580-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/3132a491b1ebf250ff7a660fd0e3527e-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/049a18879fa04c2b5f32ba15369eb8fd-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/6ab3e6be9abf541064464a7a19cc5220-0.webp)

#### 三个重要的值

堆空间有三个需要关注的值，used、total、max。used指的是当前已使用的堆内存，total是java虚拟机已经分配的可用堆内存，max是java虚拟机可以分配的最大堆内存。

![img](https://image.hyly.net/i/2025/09/24/847094aa55b7ffdf15c75701190f7b12-0.webp)

堆内存used total max三个值可以通过dashboard命令看到。

> 手动指定刷新频率（不指定默认5秒一次）：`dashboard –i  刷新频率(毫秒)`

![img](https://image.hyly.net/i/2025/09/24/e9c1f4906dcd12c014cf07679f049632-0.webp)

随着堆中的对象增多，当total可以使用的内存即将不足时，java虚拟机会继续分配内存给堆。

![img](https://image.hyly.net/i/2025/09/24/9a9a1ddaac16e74566059f3b750eb30b-0.webp)

此时used达到了total的大小，Java虚拟机会向操作系统申请更大的内存。

![img](https://image.hyly.net/i/2025/09/24/4b17c8e5c9e0f3272dcec0b57fce51ee-0.webp)

但是这个申请过程不是无限的，total最多只能与max相等。

![img](https://image.hyly.net/i/2025/09/24/f46a0729ab4fc7e607c2238ce03565f8-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/b102830460ef36e040bcdc95a52e2550-0.webp)

使用`arthas`的`memory`命令同样可以看到：

![img](https://image.hyly.net/i/2025/09/24/6bda183127f45e9117972f89ea4658e1-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/358c3ee2eab0c6fb688fab746798681d-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/c7e53c54fc505769b9dcc4f16964724a-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/c07842d40baf3915a61fcb89dc230a14-0.webp)

可以通过arthas的`memory`命令看到方法区的名称以及大小：

- JDK7及之前的版本查看ps_perm_gen属性。

![img](https://image.hyly.net/i/2025/09/24/fe27a2aaf55fbb45434155dc043b86f4-0.webp)

- JDK8及之后的版本查看metaspace属性。

![img](https://image.hyly.net/i/2025/09/24/8b8cd6022bc0b50b0484723d5cc2ca88-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/66734811402074a760f13ece15082c75-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/c981737de2a751cedcaf15702c00b4e1-0.webp)

这次就出现了MetaSpace溢出的错误：

![img](https://image.hyly.net/i/2025/09/24/9b5683ff7f24c04ead9fbd84c45a7075-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/6176ef2bd69a8c406967c6bd5d1c3318-0.webp)

接下来通过s2局部变量引用字符串常量池的`abc`。

![img](https://image.hyly.net/i/2025/09/24/db821caa54c6e5388d3b8203a2698294-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/9a72553b6bef1e973f26d60234fc1d33-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/a4efd1df0e6ed2f36c91d1dffb8361b9-0.webp)

2、同理处理b和c：

![img](https://image.hyly.net/i/2025/09/24/05990e98629200c18ff68e7189924692-0.webp)

3、将a和b指向的字符串进行连接，本质上就是使用StringBuilder进行连接，最后创建了一个新的字符串放入堆中。然后将局部变量d指向堆上的对象。

![img](https://image.hyly.net/i/2025/09/24/999783864868e666689e8d64f203cda9-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/92003a8331a4bd3420192132a3b9374c-0.webp)

说明在编译阶段，已经将1和2进行连接，最终生成12的字符串常量池中的结果。所以返回结果就是true，c和d都指向字符串常量池中的对象。

总结一下：

![img](https://image.hyly.net/i/2025/09/24/cba78b09ad459273f0b043544146645a-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/adf9d2f2ba08d63c764a4956405b5492-0.webp)

2、调用s1.intern方法，会在字符串常量池中创建think123的对象，最后将对象引用返回。所以s1.intern和s1指向的不是同一个对象。打印出false。

![img](https://image.hyly.net/i/2025/09/24/187d7ad4a1a461f6187387d2b434a6f5-0.webp)

3、同理，通过StringBuilder在堆上创建java字符串对象。这里注意字符串常量池中本来就有一个java字符串对象，这是java虚拟机自身使用的所以启动时就会创建出来。

![img](https://image.hyly.net/i/2025/09/24/49ed67a50d0e692a5d9cb692ac9e55a2-0.webp)

4、调用s2.intern发现字符串常量池中已经有java字符串对象了，就将引用返回。所以s2.intern指向的是字符串常量池中的对象，而s2指向的是堆中的对象。打印结果为false。

![img](https://image.hyly.net/i/2025/09/24/5dab2c01117cffb83bc026a12be6017d-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/cc4aa5f2ab8d4c927ead532ce52b207d-0.webp)

2、s2.intern方法调用时，字符串常量池中已经有java字符串了，所以将引用返回。这样打印出来的结果就是false。

![img](https://image.hyly.net/i/2025/09/24/6f1f97701bffa112a658f77e6a0cbca3-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/6319ff770f64a95cf7c53263651b99c2-0.webp)

使用直接内存创建对象的过程，不需要进行复制对象，数据直接存放在直接内存中：

![img](https://image.hyly.net/i/2025/09/24/edbdf074b65e7f1b694f6d011bf2d127-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/1c71325150e1946a4faf037933ab4617-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/23db8667a666f71fe8264b8fb1ee3e8b-0.webp)

如果将`Thread.`*`sleep`*`(5000);`注释掉，让直接内存快速大量分配。操作系统内存不足时就会报错：

![img](https://image.hyly.net/i/2025/09/24/fabfe5c5fd3cae758a88d1cf2fe44fa8-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/49becb156d44d8b3b840ccf3bd9458e1-0.webp)

直接循环11次之后，超过最大值就会报错：

![img](https://image.hyly.net/i/2025/09/24/d579572eb605d9118f3bc7ae784fc1ca-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/a9f301ccbb8efccfb813b3232704ecd8-0.webp)

这段代码中，手动调用`delete`删除对象，就不会出现内存泄漏。

![img](https://image.hyly.net/i/2025/09/24/38e1779ac913ca9d8449e78d7c5b7294-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/5a29a05e7e24cb8ae0c580e4ca93ab5f-0.webp)

![img](https://image.hyly.net/i/2025/09/24/3e2d7d1246dbefe1d624ef43cd5fe297-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/eaa9148b2e4cd626f29bb3a66c73e0f0-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/d11cb51c154c408bc1cc94f8b0bd1c3b-0.webp)

2、加载该类的类加载器已经被回收。

这段代码让局部变量对类加载器的引用去除，类加载器就可以回收。

![img](https://image.hyly.net/i/2025/09/24/4c503b7a6c45f56278731c0201696a53-0.webp)

3、该类对应的 java.lang.Class 对象没有在任何地方被引用。

![img](https://image.hyly.net/i/2025/09/24/a2a11248f2acc279454c5ce1988572d1-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/de36fb70e8e76821462fffafd1bf562d-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/d7a779b7d0eef8ee4e7cd6d0cd6ad6e1-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/9eefba411c82bd1af8b612c5638ea47c-0.webp)

第二行代码执行之后，局部变量对堆上的对象引用去掉，那么堆上的对象就可以被回收了。

![img](https://image.hyly.net/i/2025/09/24/0eff8201cd5fcd80ff57460d6034631b-0.webp)

一个更复杂的案例：

![img](https://image.hyly.net/i/2025/09/24/796070c05334cbd327e63408e146ca73-0.webp)

这个案例中，如果要让对象a和b回收，必须将局部变量到堆上的引用去除。

![img](https://image.hyly.net/i/2025/09/24/6f30d5d636dd09b2483417d217bb7475-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/5671170bb412964109e5fc99216d34f8-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/91b2405e4c2e0fcd6ff60316eb392d34-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/b066c9ab48a38e01ec2fced47704b506-0.webp)

加上这个参数之后执行代码，发现对象确实被回收了：

![img](https://image.hyly.net/i/2025/09/24/38f3a9d07fbc049f2527845b35a3f7f8-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/928d43d333bbe034bad031d0f00abee7-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/6e640e4444b3e2bde98dd9ead3577562-0.webp)

- 监视器对象，用来保存同步锁synchronized关键字持有的对象。

![img](https://image.hyly.net/i/2025/09/24/e922d26edddab705144106f0cf3617fc-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/863bc4e6618c326f2e14af36ebe2b26b-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/ae6683cf32a11a31f8f02400abc96dab-0.webp)

这样就生成了一个堆内存快照（后面介绍，简单来说就是包含了所有堆中的对象信息）。

3、打开资料中提供的MAT工具，如果出现如下错误，请将环境变量中的JDK版本升级到17以上。

![img](https://image.hyly.net/i/2025/09/24/9bb25723e7c4461a54bf9fb07ecc1146-0.webp)

4、选择菜单中的打开堆内存快照功能，并选择刚才生成的文件。

![img](https://image.hyly.net/i/2025/09/24/0bad223a31c5140b7682e9c3a996d359-0.webp)

5、选择内存泄漏检测报告，并确定。

![img](https://image.hyly.net/i/2025/09/24/1cd067b0e74cc0226b39c52bc6f97779-0.webp)

6、通过菜单找到GC Roots。

![img](https://image.hyly.net/i/2025/09/24/a79500c3564f4349393b3d1ee806f723-0.webp)

7、MAT对4类GC Root对象做了分类。

![img](https://image.hyly.net/i/2025/09/24/b2c50473d7dcfa66bb370f89aa332ea9-0.webp)

8、找到静态变量。

![img](https://image.hyly.net/i/2025/09/24/967b72eb7d35deee656f46f0f74154e4-0.webp)

9、找到局部变量

![img](https://image.hyly.net/i/2025/09/24/441d0ced25dd50ad4ebfb4b0e306f15e-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/397daa97aad3d4fa41ca0cac13772be1-0.webp)

接下来强引用被去掉之后，对象A暂时还是处于不可回收状态，因为有软引用存在并且内存还够用。

![img](https://image.hyly.net/i/2025/09/24/bcdf204acbfa36726c04a936a11a8a3b-0.webp)

如果内存出现不够用的情况，对象A就处于可回收状态，可以被垃圾回收器回收。

![img](https://image.hyly.net/i/2025/09/24/46657f313b2ef381a68e71fa474c8f4f-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/76205a1a39e98923db308c9ef529f93b-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/30f3ce55de35275e30f8d8c1fc816063-0.webp)

执行后发现，第二个100m对象创建之后需，软引用中包含的对象已经被回收了。

![img](https://image.hyly.net/i/2025/09/24/f42765baf5197dc19318f024056209e3-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/592175ec07910c42bee0683e14713479-0.webp)

2、在软引用中包含的对象被回收时，该软引用对象会被放入引用队列

![img](https://image.hyly.net/i/2025/09/24/4d936510ca52712ec636032b11d0ccaa-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/1c1317ba916ded769e3be80d240f6409-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/da97e20e3f50293d7334e34e8ef53de0-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/832b4b40d7c1c2833795ab963ce2b0c4-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/102ec40f431c57e7e41b332dcef38edf-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/532cd3ee2fedad3e5c9fb5b3951cb440-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/524f0e2222f4d951442753e3bfa55dd1-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/56457f394dc6ec09cb1a90ccb0e82133-0.webp)

2.最大暂停时间

最大暂停时间指的是所有在垃圾回收过程中的STW时间最大值。比如如下的图中，黄色部分的STW就是最大暂停时间，显而易见上面的图比下面的图拥有更少的最大暂停时间。最大暂停时间越短，用户使用系统时受到的影响就越短。

![img](https://image.hyly.net/i/2025/09/24/ea3c8906d132df71c106cbdc6b2dbe24-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/e5bc79ba1c9136e707b4b00778657fb9-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/3e0e23a8408d55cb05236b5b13a9c4ad-0.webp)

第二个阶段，将没有标记的对象清理掉，所以对象D就被清理掉了。

![img](https://image.hyly.net/i/2025/09/24/88286214646d401f6918738a3a9f0e69-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/49f9a66d248037bf11fcc7c5eb2f9890-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/8256a0d4eac9a1f5b236f61ebcf5a2a8-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/e91ebfdc1bd7f03cf76fd8ce3ab3fead-0.webp)

2.在垃圾回收GC阶段，将From中存活对象复制到To空间。

在垃圾回收阶段，如果对象A存活，就将其复制到To空间。然后将From空间直接清空。

![img](https://image.hyly.net/i/2025/09/24/11517d7f76d2f35c6096f754187a1f08-0.webp)

3.将两块空间的From和To名字互换。

接下来将两块空间的名称互换，下次依然在From空间上创建对象。

![img](https://image.hyly.net/i/2025/09/24/fcb7a5ac9c36ace86899ff2c15496aac-0.webp)

完整的复制算法的例子：

1.将堆内存分割成两块From空间 To空间，对象分配阶段，创建对象。

![img](https://image.hyly.net/i/2025/09/24/927c73e34ca8802ff5324feb58df335b-0.webp)

2.GC阶段开始，将GC Root搬运到To空间

![img](https://image.hyly.net/i/2025/09/24/b5eec8dda920636ceadc73c6be1576eb-0.webp)

3.将GC Root关联的对象，搬运到To空间

![img](https://image.hyly.net/i/2025/09/24/f373621cce4455c2d4c64ba89b1e4fb3-0.webp)

4.清理From空间，并把名称互换

![img](https://image.hyly.net/i/2025/09/24/2200bc46c41369bac05316799cab3c44-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/d298e3fc290cbcbb7d47b01441f677f7-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/13b15a06b0c5e4a8b0888a3539872dfb-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/1edc2aaf044863cb31c4fd20ad5f3612-0.webp)
...
<figure class='table-figure'><table>
<thead>
<tr><th>参数名</th><th>参数含义</th><th>示例</th></tr></thead>
<tbody><tr><td>-Xms</td><td>设置堆的最小和初始大小，必须是1024倍数且大于1MB</td><td>比如初始大小6MB的写法： -Xms6291456 -Xms6144k -Xms6m</td></tr><tr><td>-Xmx</td><td>设置最大堆的大小，必须是1024倍数且大于2MB</td><td>比如最大堆80 MB的写法： -Xmx83886080 -Xmx81920k -Xmx80m</td></tr><tr><td>-Xmn</td><td>新生代的大小</td><td>新生代256 MB的写法： -Xmn256m -Xmn262144k -Xmn268435456</td></tr><tr><td>-XX:SurvivorRatio</td><td>伊甸园区和幸存区的比例，默认为8 新生代1g内存，伊甸园区800MB,S0和S1各100MB</td><td>比例调整为4的写法：-XX:SurvivorRatio=4</td></tr><tr><td>-XX:+PrintGCDetailsverbose:gc</td><td>打印GC日志</td><td>无</td></tr></tbody>
</table></figure>
...
![img](https://image.hyly.net/i/2025/09/24/6d92ffdcf2b2e6f80459cced39919d0e-0.webp)

heap展示的是可用堆，survivor区每次只有一块能使用，所以60 - 4 = 56m。

1、分代回收时，创建出来的对象，首先会被放入Eden伊甸园区。

![img](https://image.hyly.net/i/2025/09/24/fffe3300c76b6af7bee3bb068d702087-0.webp)

2、随着对象在Eden区越来越多，如果Eden区满，新创建的对象已经无法放入，就会触发年轻代的GC，称为Minor GC或者Young GC。

Minor GC会把需要eden中和From需要回收的对象回收，把没有回收的对象放入To区。

![img](https://image.hyly.net/i/2025/09/24/f49029efc0e2951e6b486bbe1591e631-0.webp)

3、接下来，S0会变成To区，S1变成From区。当eden区满时再往里放入对象，依然会发生Minor GC。

![img](https://image.hyly.net/i/2025/09/24/6d6f9a1c080ab36b1b188c2d48f09886-0.webp)

此时会回收eden区和S1(from)中的对象，并把eden和from区中剩余的对象放入S0。

注意：每次Minor GC中都会为对象记录他的年龄，初始值为0，每次GC完加1。

![img](https://image.hyly.net/i/2025/09/24/f9b747867acd0de15192a94d6859ebd7-0.webp)

4、如果Minor GC后对象的年龄达到阈值（最大15，默认值和垃圾回收器有关），对象就会被晋升至老年代。

![img](https://image.hyly.net/i/2025/09/24/4600dabf57deceb143e3a32eb6f433a9-0.webp)

![img](https://image.hyly.net/i/2025/09/24/16d5e62badc4174c82993b07df1916f1-0.webp)

当老年代中空间不足，无法放入新的对象时，先尝试minor gc如果还是不足，就会触发Full GC，Full GC会对整个堆进行垃圾回收。

如果Full GC依然无法回收掉老年代的对象，那么当对象继续放入老年代时，就会抛出Out Of Memory异常。

![img](https://image.hyly.net/i/2025/09/24/42cfc50253d0219f95b5fdd6f57c4c7f-0.webp)

下图中的程序为什么会出现OutOfMemory？

![img](https://image.hyly.net/i/2025/09/24/e263d01a1b270fe0c6934a062a18003c-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/10d396e87b1043bf06005ccaf594c943-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/aac479545fd6a491da813a9a7693b468-0.webp)

#### 年轻代-Serial垃圾回收器

Serial是是一种单线程串行回收年轻代的垃圾回收器。

![img](https://image.hyly.net/i/2025/09/24/9eeda09702599aa68c974052536af60c-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/9a656cd438aad142a6b297f8833eee64-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/4906397c573a0487c98fdae1265f07d3-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/1e0f494e77c4e2119b0105d2efff447b-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/50a7ecf5e475297a9402928cff1c13b5-0.webp)

最终可以得到这张图：

![img](https://image.hyly.net/i/2025/09/24/f4d6ce08693e2a0bb276eb6dfdc8bccb-0.webp)

并发标记和并发清理阶段，会使用3个线程并行处理。重新标记阶段会使用10个线程处理。

由于CPU的核心数有限，并发阶段会影响用户线程执行的性能。

![img](https://image.hyly.net/i/2025/09/24/0b2068e4f45e3f89370f7c5892ec898b-0.webp)

#### 年轻代-Parallel Scavenge垃圾回收器

Parallel Scavenge是JDK8默认的年轻代垃圾回收器，多线程并行回收，关注的是系统的吞吐量。具备自动调整堆内存大小的特点。

![img](https://image.hyly.net/i/2025/09/24/2bf2232f96c448c819d952f47eb2bdf6-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/1572ae920f4cc77c7b3b6f56a20731f1-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/7a2ac12dbe99af40f703f3fa7aab0c28-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/2075e12b976e3145ead6bfabe5f24824-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/8066329fadf19b777bcbb1b522b1cd76-0.webp)

2、标记出Eden和Survivor区域中的存活对象，

3、根据配置的最大暂停时间选择某些区域将存活对象复制到一个新的Survivor区中（年龄+1），清空这些区域。

![img](https://image.hyly.net/i/2025/09/24/33e787646b871f9d0b308b2a8202bc92-0.webp)

![img](https://image.hyly.net/i/2025/09/24/88735969a54a732f700df987160a013d-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/3a819e02c5a9cebbc365b42d3b19cc2c-0.webp)

![img](https://image.hyly.net/i/2025/09/24/7a830f10a5d5880b2b9472e50c4bce7f-0.webp)

5、当某个存活对象的年龄到达阈值（默认15），将被放入老年代。

![img](https://image.hyly.net/i/2025/09/24/899b33d908295b705f1c6b0ebb630d9e-0.webp)

6、部分对象如果大小超过Region的一半，会直接放入老年代，这类老年代被称为Humongous区。比如堆内存是4G，每个Region是2M，只要一个大对象超过了1M就被放入Humongous区，如果对象过大会横跨多个Region。

![img](https://image.hyly.net/i/2025/09/24/0a3e4382a57a1a6924fcae2def64d7a2-0.webp)

7、多次回收之后，会出现很多Old老年代区，此时总堆占有率达到阈值时

（-XX:InitiatingHeapOccupancyPercent默认45%）会触发混合回收MixedGC。回收所有年轻代和部分老年代的对象以及大对象区。采用复制算法来完成。

![img](https://image.hyly.net/i/2025/09/24/dae7996f80245cb3c1a83660e70c0610-0.webp)

![img](https://image.hyly.net/i/2025/09/24/5ce05f46ed81de13ca27359d74a73f2f-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/3af5820239b6942e44ab4becfd419a03-0.webp)

G1对老年代的清理会选择存活度最低的区域来进行回收，这样可以保证回收效率最高，这也是G1（Garbage first）名称的由来。最后清理阶段使用复制算法，不会产生内存碎片。

![img](https://image.hyly.net/i/2025/09/24/f2c536f2d38fa99b1d9979238e8e3b44-0.webp)

注意：如果清理过程中发现没有足够的空Region存放转移的对象，会出现Full GC。单线程执行标记-整理算法，此时会导致用户线程的暂停。所以尽量保证应该用的堆内存有一定多余的空间。

![img](https://image.hyly.net/i/2025/09/24/bfda245812c8cd16103490068ea0d9da-0.webp)
...
![img](https://image.hyly.net/i/2025/09/24/582d9a8857e2cf2abbb8cbc18f78449b-0.webp)

初始标记花了0.0478秒。

![img](https://image.hyly.net/i/2025/09/24/609d069ae49a36c8af3d6a97760b2f16-0.webp)

并发标记总共耗时10ms，不会产生STW。

![img](https://image.hyly.net/i/2025/09/24/fbe52dc588bbabd20ae266c1deabd3d4-0.webp)

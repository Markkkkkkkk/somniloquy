...
另外，我偶然发现安装多语言支持插件（比如[插件 – GTranslate](https://hyly.net/categroy/article/code/wordpress/310#header-id-7)）会明显增加网站在bing等搜索引擎的曝光率。小伙伴们也可以试试看！
...
首先在插件市场搜索`Broken Link Checker`安装并启用，

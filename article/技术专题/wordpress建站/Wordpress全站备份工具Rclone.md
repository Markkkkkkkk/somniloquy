...
大家通过Wordpress的一系列文章，想必已经能把自己的博客网站独立建设起来了，之后就是疯狂写文章发布了。虽然有之前的[服务器和wordpress网站安全防护](https://www.hyly.net/article/code/wordpress/444)，能解决大部分的安全问题。但我们要假设一种极端情况就是服务器连不上了，网站崩了，总之各种原因网站用不了了，我们能否马上另起炉灶或者恢复呢？这就是全站备份了。实现的效果就是不管遇到任何极端情况，网站数据在自己手里，换个服务器，或者哪怕换个域名也能快速把自己这一套部署起来！

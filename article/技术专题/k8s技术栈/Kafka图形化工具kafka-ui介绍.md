---
category: [k8s技术栈]
tag: [kafka,kafkaTool,offsetExplore,kafkaAssistant,kafka-ui]
postType: post
status: publish
---
...
搜索[官网](https://www.kafkatool.com/)找到Download下载对应的版本直接安装即可。

![image-20260624133615596](https://image.hyly.net/i/2026/06/24/82034e09a79256e2d939dd6a597fd85b-0.webp)
...
因为k8s集群里使用了kafka三节点部署，所以映射为三个，Kafka域名也可以根据k8s集群里实际对外暴漏的服务名进行修改。如果不知道集群里具体的域名可以通过命令`kubectl get svc -n kafka`进行查看：

![image-20260624134509992](https://image.hyly.net/i/2026/06/24/7c7ed2f97138b65154edc82b3a9fab95-0.webp)

host添加完IP域名映射后，需要执行`ipconfig /flushdns`进行刷新缓存，因为offsetExplore打开时会记录旧的DNS域名，所以如果是先打开offsetExplore后添加的host的IP域名映射，可能会不成功，这时候就要关闭软件重新刷新下DNS缓存即可。
...
![image-20260624135456198](https://image.hyly.net/i/2026/06/24/d62b68497a37d533fc895a2bf1db8cc4-0.webp)
...
![image-20260624135914883](https://image.hyly.net/i/2026/06/24/31fbb1f5878f7f49ccaad3467f666c8a-0.webp)
...
![image-20260624140203838](https://image.hyly.net/i/2026/06/24/2302d7751b9e9cc4b1db232b027abea4-0.webp)
...
![image-20260624141849043](https://image.hyly.net/i/2026/06/24/edfc31223b99965da0e22d1e4c93e8a1-0.webp)

#### Consumers

在消费者菜单里，找到具体的消费者，点击offsets可以查看当前消费者都消费了哪个topic，哪些partition，消费的offset到哪里了，以及更重要的有没有滞后，这个指标可以确认是否存在未消费信息，也能间接的证明是否发送给了下游服务。

![image-20260624142932335](https://image.hyly.net/i/2026/06/24/2c07f0853bea689c2186a377163440fd-0.webp)

## Kafka Assistant

继OffsetExplore之后，[Kafka Assistant](http://www.redisant.cn/)也是一个本地工具，其优点是比OffsetExplore提供了更丰富的指标，也支持消息的时间点查询。如果不介意它需要付费使用以及需要装到本地的特点话，倒是值得一用。大家也可以到[B站](https://www.bilibili.com/video/BV1GM411877o/?spm_id_from=333.337.search-card.all.click&vd_source=690dbd332225cfade4b32ec9fb611b49)观看更详细的视频介绍。

![image-20260624143712689](https://image.hyly.net/i/2026/06/24/802626a8129b0d18eff298223d90fa33-0.webp)

### 同系列产品拓展

发现这个厂家同系列也有一些有意思的产品，比方说MQTT、Modbus工具在工业物联网看起来挺好用的（因为之前用过其它Modbus模拟器，是真不好用，如果再有机会一定要试下），如果大家有需要的话可以去尝试下。

![image-20260624144537380](https://image.hyly.net/i/2026/06/24/ded98e7b6ee1f902214320c740858467-0.webp)

![image-20260624144712940](https://image.hyly.net/i/2026/06/24/f6302900e53a9ab95fe7c9030d737c78-0.webp)

### 核心功能

![image-20260624143841822](https://image.hyly.net/i/2026/06/24/cf03076e5e677b1ecb23781eda038095-0.webp)

#### 连接Kafka

![image-20260624145220987](https://image.hyly.net/i/2026/06/24/1d6e345c0efec52e38809045e626fc7b-0.webp)

#### 查看健康指标

![image-20260624145239485](https://image.hyly.net/i/2026/06/24/933c9b27f03dff1ca7997403b0a5cd12-0.webp)

#### 支持丰富数据格式

![image-20260624145303415](https://image.hyly.net/i/2026/06/24/017ff3968139f95358c13482ef976438-0.webp)

#### 消费和发送消息

![image-20260624145327350](https://image.hyly.net/i/2026/06/24/c1d238be71749f50039039d86743f13a-0.webp)

#### 查看和更新Kafka配置

![image-20260624145402908](https://image.hyly.net/i/2026/06/24/b9b95e212337fb07b458bc3c033bfd6f-0.webp)

#### 生成拓扑图

![image-20260624145424895](https://image.hyly.net/i/2026/06/24/1237ccdf2e6db3ee35d96394d83d91de-0.webp)

#### 消息绘制图表

![image-20260624145451400](https://image.hyly.net/i/2026/06/24/e5901f8d9383c36f4ac186649f6f38bd-0.webp)
...
![image-20260624154247668](https://image.hyly.net/i/2026/06/24/00d06eb01ea0ab8caec76dda269d8c6f-0.webp)

同样也可以看到Kafka日志的存储目录显示。

![image-20260624154423192](https://image.hyly.net/i/2026/06/24/913d935278b49b91c9d9eed3003011ba-0.webp)

可视化更改Kafka的配置。

![image-20260624154628931](https://image.hyly.net/i/2026/06/24/606dbeb240e6a5bd657059430a7c5341-0.webp)

#### Topics

在topics页面可以查看更详细的信息。

![image-20260624154817557](https://image.hyly.net/i/2026/06/24/ee360780256c768186a7a0fb677bb8ec-0.webp)

概述页面。进入某topics可以查看该topics更详细的信息，也可以直接创建消息。

![image-20260624155005084](https://image.hyly.net/i/2026/06/24/5a09f2e88c33864b7f9268d5b99b90ac-0.webp)

消息页面。可以根据offset偏移量查询、也可以根据时间点查询、可以选择查询哪个分区里的消息、key/value的类型、以及按照最新、最老排序，也支持强大的实时模式，在DEBUG场景下特别好用。

![image-20260624155801588](https://image.hyly.net/i/2026/06/24/6d92a96a02ff55bd8727e75596e7288d-0.webp)

点击下边某条消息则可以查看具体值。

![image-20260624160123851](https://image.hyly.net/i/2026/06/24/6635449204115b8ad0f1befb512af5f1-0.webp)

在消费者页面可以查看都有哪些消费者订阅了这个topic，以及各消费者的消费情况。

![image-20260624160342911](https://image.hyly.net/i/2026/06/24/84db0dddab01448df1777c3b2d7aa294-0.webp)

设置页可以查看topics的配置信息。

![image-20260624162818058](https://image.hyly.net/i/2026/06/24/7bf9b29168f39cdd2a441acd199e1f14-0.webp)

统计数据页面可以查看当前topics的状态信息。

![image-20260624162851472](https://image.hyly.net/i/2026/06/24/a81d349f94ebd041750e6fc8c9a2020b-0.webp)

#### Consumers

在消费者页面，点击具体的消费者，可以查看该消费者在每个partition的消费情况。

![image-20260624163029339](https://image.hyly.net/i/2026/06/24/177770df6426eea266767894ed27a0a0-0.webp)
